...
export function directCamera(camera,t,lead,surfaceHeight){
  ...
  if(shot==='arrival'){
    ...
    camera.fov=(portrait?56:42)-progress*8;
    camera.position.set((portrait?260:560)-progress*130,285,(portrait?2000:1000)-progress*400);
    // Lower the gaze from the distant fleet to the emerging planetary limb.
    target.set(0,95+(1-progress)*380,-1000);
  }else if(shot==='hull'){
    ...
    const progress=THREE.MathUtils.smoothstep(t,CUTS[1],DURATION);
